...
<div class="form-control-block">
    ...
    <div class="form-group">
        <div class="buttonRow back"><?php echo zen_image_submit('', BUTTON_LOGIN_ALT); ?></div>
        <div class="buttonRow back"><?php echo '&nbsp; &nbsp; &nbsp;<a  class="forgot_pass" href="' . zen_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></div>
    </div>
    </form>
</div>
<br class="clearBoth" />
