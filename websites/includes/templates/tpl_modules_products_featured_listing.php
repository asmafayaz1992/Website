  ...
  if ($featured_products_split->number_of_rows > 0) {
    ...
    while (!$featured_products->EOF) { 
      ...
      if (PRODUCT_NEW_LIST_DESCRIPTION > '0') {
		...
		$the_button3 = '<div class="button"><a class="btn products-button add-to-cart" href="' . zen_href_link(FILENAME_featured_products, zen_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $featured_products->fields["products_id"]) . '">' . zen_image_button(BUTTON_IMAGE_ADD_TO_CART, BUTTON_IN_CART_ALT) . '</a></div>';
