...
if ($num_products_count > 0) {
  ...
  while (!$featured_products->EOF) {
	...
	$products_butt2 = '<a class="btn products-button add-to-cart" href="' . zen_href_link(FILENAME_DEFAULT, zen_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $featured_products->fields["products_id"]) . '">' . zen_image_button(BUTTON_IMAGE_ADD_TO_CART, BUTTON_IN_CART_ALT) . '</a>';
