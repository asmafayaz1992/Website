...
// if USE_DEFAULT_LANGUAGE_CURRENCY is true, use the following currency
...
// Define the name of your Gift Certificate as Gift Voucher, Gift Certificate, Zen Cart Dollars
