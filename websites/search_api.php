				...
				if ($result->number_of_rows > 0) {
					...
					<div id="suggestionPaging">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr><td width="33%"><?php if ($prevPage) { ?><span id="suggestionPrev"></span><?php } ?></td>
                                <td width="33%"><span id="suggestionCount"><?php echo $result->current_page_number ?> / <?php echo $result->number_of_pages ?></span></td>
                                <td width="33%"><?php if ($nextPage) { ?><span id="suggestionNext"></span><?php } ?></td>
                            </tr>
                        </table>
					</div>
					<?php
